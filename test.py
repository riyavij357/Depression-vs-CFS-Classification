...
lr = pickle.load(open('me_cfs_vs_depression.csvlr1.pkl','rb'))
dt = pickle.load(open('me_cfs_vs_depression.csvdt1.pkl','rb'))
rf = pickle.load(open('me_cfs_vs_depression.csvrf1.pkl','rb'))
...
with col1:
  ...
  bf_level = st.number_input('Brain Fog Level',0,10,2)
